      ...
      <div className="max-w-full mx-auto p-6 space-y-8 bg-white text-black">
        ...
        <div className="px-10">
          <p className="text-gray-700">
            At LumiAI, we are committed to ensuring the integrity and fairness of our vetting process for developers. To
            maintain a high standard, we have implemented a rigorous AI-powered vetting system designed to evaluate
            candidates' technical skills accurately. This policy outlines our anti-cheating rules and the measures we take
            to prevent and detect any dishonest behavior during the vetting process.
          </p>
        </div>
