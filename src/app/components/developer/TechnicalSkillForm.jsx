...
export default function TechnicalSkillsForm({ onBack, onNext }) {
  ...
  return (
    <div className="max-w-2xl p-6 space-y-6">
      ...
      <div className="flex justify-between pt-4">
        <button className="px-4 py-2 border rounded-md hover:bg-gray-50 text-black" onClick={() => onBack('education')}>Back</button>
