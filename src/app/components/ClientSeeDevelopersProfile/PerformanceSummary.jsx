...
export function PerformanceSummary() {
  const [activeTab, setActiveTab] = useState("LumoAI Vetting Results")

  const tabs = ["LumoAI Vetting Results", "About John", "Work Experience"]
    ...
    <div className="p-4 space-y-6">
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm transition-colors ${
              activeTab === tab ? "bg-blue-600 text-white" : "bg-blue-100 text-blue-600 hover:bg-blue-200"
            }`}
          >
            {tab}
          </button>
      ...
      {activeTab === "LumoAI Vetting Results" && (
        <>
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-center">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600 mt-1">Senior-level</div>
              </div>
          ...
          <button className="px-4 py-2 bg-blue-300 text-white rounded hover:bg-blue-700">
              Soft Skills
            </button>
