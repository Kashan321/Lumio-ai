import { TechBadge } from "@/app/components/DeveloperProfile/TechBadge"
      ...
      <div className="mx-auto max-w-2xl bg-gradient-to-b from-blue-200 to-pink-200 px-6 pb-6 rounded-xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            <TechBadge icon="/placeholder.svg" name="Python" />
            <TechBadge icon="/placeholder.svg" name="Angular" />
            <TechBadge icon="/placeholder.svg" name="React.JS" />
            <TechBadge icon="/placeholder.svg" name="AWS" />
            <TechBadge icon="/placeholder.svg" name="JavaScript" />
          </div>
        </div>
